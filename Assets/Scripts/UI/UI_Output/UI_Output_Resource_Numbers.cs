...
public class UI_Output_Resource_Numbers : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        System_Static_Player_Resource.OnUpdateUI += Update_UI;
    ...
    void Update_UI()
    {
        ...
        text_Money.text = System_Static_Player_Resource.money.ToString();
        text_Physical.text = System_Static_Player_Resource.GetItemCountByTag(Base_Data.DataTags.Physical).ToString();
        text_Society.text = System_Static_Player_Resource.GetItemCountByTag(Base_Data.DataTags.Society).ToString();
        text_Spirit.text = System_Static_Player_Resource.GetItemCountByTag(Base_Data.DataTags.Spirit).ToString();
    }
}